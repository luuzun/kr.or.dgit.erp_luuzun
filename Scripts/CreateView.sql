...
SELECT * FROM view_client_sale WHERE clnt_code="CL001";
SELECT * FROM view_client_sale WHERE clnt_code=#{clnt_code};         
...
SELECT comp_name, order_date, clnt_name, sw_name, sale_price, sale_amount, total_sale_price, tax, tax_saleprice
	FROM view_bill_list;
