package kr.or.dgit.erp_luuzun.application.delivery;
...
public class ContentDelivery extends JPanel {
	...
	public ContentDelivery() {
		...
		JLabel label = new JLabel("소프트웨어 입고 관리");
		...
		gbc_tfpDelOrderDate.insets = new Insets(0, 0, 5, 5);
		...
		gbc_tfpIsExist.insets = new Insets(0, 0, 5, 5);
