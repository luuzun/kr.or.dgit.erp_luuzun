...
import kr.or.dgit.erp_luuzun.table.TableSale;
...
public class ViewSale extends JPanel {
	...
	public ViewSale() {
		...
		gbc_pContent.fill = GridBagConstraints.HORIZONTAL;
		...
		gbc_pButton.insets = new Insets(0, 0, 5, 0);
		...
		gbl_pButton.rowHeights = new int[]{53, 0};
